...
bikes = data_controller.load_data('bikes')
clients = data_controller.load_data('clients')
partners = data_controller.load_data('partners')
bills = data_controller.load_data('bills')
