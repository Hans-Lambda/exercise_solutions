...
class BullshitGenerator:
    ...
    def generate_user(self):
        ...
        user = User(self.names[random.randint(0, 3)], self.usernames[random.randint(0, 3)], self.password[random.randint(0, 3)])
    ...
    def generate_bikes(self, user):
        ...
        bike = Bike(random.randint(1, 25), self.manufacturer[random.randint(0, 3)], self.types[random.randint(0, 3)], user)
